...
export default {
  ...
  data () {
    return {
      modalVisible: false,
      cards: [
        { id: '1', productName: 'Наименование товара', decription: 'Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько строк', imgLink: '/_nuxt/assets/images/card-image.jpg', price: '10 000' },
        { id: '2', productName: 'Наименование товара', decription: 'Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько строк', imgLink: '/_nuxt/assets/images/card-image.jpg', price: '10 000' },
        { id: '3', productName: 'Наименование товара', decription: 'Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько строк', imgLink: '/_nuxt/assets/images/card-image.jpg', price: '10 000' },
        { id: '4', productName: 'Наименование товара', decription: 'Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько строк', imgLink: '/_nuxt/assets/images/card-image.jpg', price: '10 000' }
      ]
    }
  },
